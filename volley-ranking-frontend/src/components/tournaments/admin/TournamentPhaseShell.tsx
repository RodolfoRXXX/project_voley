    ...
    <div className="space-y-3">
      {phases.map((phase) => {
        ...
        return (
          <div
            key={phase.id}
            className={`rounded-md border p-3 ${isCurrent ? "border-orange-300 bg-orange-50 dark:border-orange-800 dark:bg-orange-950" : "border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-950"}`}
          >
...
export function TournamentPhaseShell({
  ...
  return (
    <section className="rounded-md border border-neutral-200 bg-white p-5 space-y-5 dark:border-neutral-800 dark:bg-neutral-950">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-2">
          <div>
            <p className="text-sm font-medium text-orange-600">Operación de fase</p>
            <div className="mt-1 inline-flex rounded-md border border-orange-200 bg-orange-50 px-3 py-1.5 dark:border-orange-800 dark:bg-orange-950">
        ...
        <div className="w-full max-w-md rounded-md border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-800 dark:bg-neutral-900/50">
