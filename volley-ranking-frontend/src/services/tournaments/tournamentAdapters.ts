...
export function toTournamentMatch(id: string, data: Record<string, unknown>): TournamentMatch {
  return {
    ...
    bracketIndex: data.bracketIndex == null ? null : Number(data.bracketIndex || 0),
    sourceHomeMatchId: typeof data.sourceHomeMatchId === "string" ? data.sourceHomeMatchId : null,
    sourceAwayMatchId: typeof data.sourceAwayMatchId === "string" ? data.sourceAwayMatchId : null,
    sourceHomeSlot: typeof data.sourceHomeSlot === "string" ? data.sourceHomeSlot : null,
    sourceAwaySlot: typeof data.sourceAwaySlot === "string" ? data.sourceAwaySlot : null,
    matchdayNumber: data.matchdayNumber == null ? null : Number(data.matchdayNumber || data.round || 0),
    roundCycle: data.roundCycle == null ? null : Number(data.roundCycle || 1),
