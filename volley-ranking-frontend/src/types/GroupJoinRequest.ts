...
export type GroupJoinRequestApprovalEffect = "CREATE_MEMBERSHIP" | "REACTIVATE_MEMBERSHIP" | "RENEW_MEMBERSHIP";
export interface PendingGroupJoinRequestForOwner { id: string; estado: "pendiente"; decisionStatus: GroupJoinRequestDecisionStatus; createdAt: string; person: { firstName: string; lastName: string }; approvalEffect: GroupJoinRequestApprovalEffect; }
...
export type GroupJoinRequestErrorReason = "UNAUTHENTICATED" | "ACCOUNT_REQUIRED" | "PERSON_REQUIRED" | "PERSON_INCOMPATIBLE" | "GROUP_NOT_AVAILABLE" | "GROUP_INCOMPATIBLE" | "GROUP_NOT_ACCESSIBLE" | "OWNER_CANNOT_REQUEST" | "ACTIVE_MEMBERSHIP_EXISTS" | "REQUEST_ALREADY_PENDING" | "REQUEST_NOT_FOUND" | "REQUEST_NOT_PENDING" | "REQUEST_CANCELLED" | "DECISION_ALREADY_APPROVED" | "DECISION_ALREADY_REJECTED" | "APPROVAL_IN_PROGRESS" | "OPEN_SEASON_REQUIRED" | "SEASON_INCOMPATIBLE" | "MEMBERSHIP_REACTIVATION_REQUIRED" | "MEMBERSHIP_SEASON_NOT_REACTIVATABLE" | "MEMBERSHIP_REACTIVATION_SUPERSEDED" | "MEMBERSHIP_RENEWAL_SUPERSEDED" | "MEMBERSHIP_PREDECESSOR_INCOMPATIBLE" | "MEMBERSHIP_INCOMPATIBLE_STATE" | "NOT_AUTHORIZED" | "VALIDATION_FAILED" | "IDEMPOTENCY_CONFLICT" | "INCOMPATIBLE_STATE" | "CONFLICT" | "DEPENDENCY_UNAVAILABLE" | "INTERNAL_ERROR";
