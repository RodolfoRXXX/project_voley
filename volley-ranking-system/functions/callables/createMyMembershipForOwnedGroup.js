...
module.exports = functions.https.onCall(createMembershipCallableHandler({ operation: service.createMyMembershipForOwnedGroup, operationName: "create", validatePayload: validateCreateMembershipPayload }));
