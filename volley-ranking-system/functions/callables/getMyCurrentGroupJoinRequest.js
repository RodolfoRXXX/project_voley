...
module.exports = functions.https.onCall(handler({ operation: service.getMyCurrentGroupJoinRequest, operationName: "get-current", validatePayload: validateGroupJoinRequestGroupPayload }));
