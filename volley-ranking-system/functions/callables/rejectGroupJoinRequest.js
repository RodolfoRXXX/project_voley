...
module.exports = functions.https.onCall(handler({ operation: service.rejectGroupJoinRequest, operationName: "reject", validatePayload: validateGroupJoinRequestDecisionPayload }));
