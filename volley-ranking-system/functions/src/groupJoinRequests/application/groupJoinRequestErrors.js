...
const definitions = {
  ...
  RequestCancelled: ["REQUEST_CANCELLED", "Request was cancelled"],
  DecisionAlreadyApproved: ["DECISION_ALREADY_APPROVED", "Request was already approved"],
  DecisionAlreadyRejected: ["DECISION_ALREADY_REJECTED", "Request was already rejected"],
  ApprovalInProgress: ["APPROVAL_IN_PROGRESS", "Request approval is in progress"],
  ...
  MembershipRenewalSuperseded: ["MEMBERSHIP_RENEWAL_SUPERSEDED", "The renewed Membership was finalized before approval"],
  MembershipPredecessorIncompatible: ["MEMBERSHIP_PREDECESSOR_INCOMPATIBLE", "The Membership predecessor is incompatible"],
  MembershipIncompatibleState: ["MEMBERSHIP_INCOMPATIBLE_STATE", "Membership state is incompatible"],
  NotAuthorized: ["NOT_AUTHORIZED", "The actor is not authorized"],
  GroupNotAccessible: ["GROUP_NOT_ACCESSIBLE", "Group is not accessible"],
